    ...
    <div className='home'>
      ...
      <div className='home__row'>
        ...
        <Product title="cracking the coding interview"
         ...
         rating={5}/>
        <Product title="Apple iPhone 13 (256GB)"
          price={799}
      ...
      <div className='home__row'>
        <Product title="Red Tape Men Hooded Sweatshirt"
          price={80}
        ...
        <Product title="Apple Watch Series 8"
          ...
          rating={4}/>
        <Product title="Samsung 275L 3 Star Inverter Frost"
          price={400}
      ...
      <div className='home__row'>
        <Product title="ASUS ROG Strix G17"
          price={800}
